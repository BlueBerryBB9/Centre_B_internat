 ...
 */
final class Version20240423085305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chambre (id INT AUTO_INCREMENT NOT NULL, n_chambre INT NOT NULL, nom_bat VARCHAR(100) NOT NULL, capacite INT NOT NULL, capacite_lit TINYINT(1) NOT NULL, handicap VARCHAR(255) DEFAULT NULL, formation VARCHAR(255) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
